...
function AboutPage({ showScrollDown = false }) {
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row text-white px-[20px] md:px-[50px] py-[30px] relative bg-background ">
      <div className="w-full sm:w-[50%] lg:w-[60%] flex-col gap-4">
        <Tag tagName="<html>" />
        ...
        <div className="flex text-[12px] sm:text-[14px] font-medium max-w-[600px] flex-col mt-2 ml-2 sm:ml-4 xl:ml-12 xl:text-[16px] gap-4">
          ...
          <p>
            Well-organised person, problem solver. Fan of Scifi Movies, outdoor
            activities, Web series and Anime.
          </p>
          <p>
            Interested in the entire frontend spectrum and working on ambitious
            projects with positive people.
          </p>
          <Link href={'/contact'} className="text-cyan text-md cursor-pointer">
      ...
      <div className="w-full sm:w-[50%] lg:w-[40%] flex items-center justify-center mx-auto">
        <div
