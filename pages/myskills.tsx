...
const ExperienceCard = ({
  ...
  return (
    <motion.div
      className="flex flex-col gap-2 w-full h-full rounded-md bg-[#2a2a2a] text-[#ababab] p-6 min-w-[200px] min-h-[200px]"
      initial={{ scale: 0 }}
      animate={{ rotate: 360, scale: 1 }}
      transition={{ duration: 2 }}
    >
      <h1 className="text-[24px] font-bold text-white">{position}</h1>
